...
import { eliminarColaborador } from '../../../backend/controllers/proyectoControllers'
                            ...
                            <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                             ...
                             <button
                               ...
                               className="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2
                                bg-white text-base font-medium text-gray-700 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2
